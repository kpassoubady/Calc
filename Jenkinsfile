node('win') {
    ...
    stage('Email Notifications') {
        mail bcc: '', body: 'Please visit ${BUILD_URL} for more information', cc: '', from: 'Jenkins Notification Server(noreply@kavinschool.com)', replyTo: '', subject: ' ${JOB_NAME} build completed', to: 'kangs@kavinschool.com'
    }
